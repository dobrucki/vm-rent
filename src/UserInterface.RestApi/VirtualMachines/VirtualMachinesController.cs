...
using Core.Application.VirtualMachines.Commands.CreateVirtualMachine;
using Core.Application.VirtualMachines.Commands.DeleteVirtualMachine;
using Core.Application.VirtualMachines.Commands.EditVirtualMachineDetails;
using Core.Application.VirtualMachines.Queries.GetVirtualMachine;
using Core.Application.VirtualMachines.Queries.ListVirtualMachines;
using MediatR;
